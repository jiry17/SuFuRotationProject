...
sliding_window = \valid: List -> Bool.
  let run = fix (
    \f: List -> List -> Reframe List -> Reframe List -> Reframe List.
    \l: List.                   /* The suffix corresponding to the left boundary. */
    \r: List.                   /* The suffix corresponding to the right boundary. */
    \seg: Reframe List.                 /* The current segment. */
    \state: Reframe List.               /* The prefix to the right boundary. */
    match r with 
      nil _ -> state
...
main = \xs: List. sliding_window positive xs;
